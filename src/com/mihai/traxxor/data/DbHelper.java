...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String CLEAR = " DELETE FROM ";
    ...
    public static String getCreateStopwatchesTable(int type) {
        ...
        return (CREATE + tableName
            + OPEN
                    ...
                    + StopwatchesTable.COL_IS_WORK + INTEGER
            + CLOSE + END);
    }

    public static String getCreateStopwatchDaysTable(int type) {
    ...
    public static String getCreateActionsTable(int type) {
    ...
    public void createTables(SQLiteDatabase db, int type) {
    ...
    public void clearTempTables(SQLiteDatabase db) {
    ...
    public void writeToTable(SQLiteDatabase db, Stopwatch watch, int writeType) {
        ...
        values.put(StopwatchesTable.COL_IS_WORK, 0); // TODO implement this
    ...
    public Pair<Stopwatch, ArrayList<Stopwatch>> readFromTable(String day, int readType) {
        SparseArray<Stopwatch> watchLookup = new SparseArray<Stopwatch>();
        ...
        int isWorkIndex = c.getColumnIndex(StopwatchesTable.COL_IS_WORK);
        while(c.moveToNext()) {
            ...
            boolean isWork = c.getInt(isWorkIndex) == 1;
        ...
        return new Pair<Stopwatch, ArrayList<Stopwatch>>(masterWatch, watches);
    }
