...
public class ManagerAdapter extends BaseAdapter implements OnClickListener {
    ...
    public void onClick(final View v) {
        Object tagType = v.getTag(R.integer.tag_type);
        Object id = v.getTag();
        if ((tagType instanceof Integer)
                && ((Integer) tagType == R.integer.type_delete)
    ...
    public synchronized View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (name != null && id != null) {
            ...
            ImageView deleteView = convertView.findViewById(R.id.delete);
